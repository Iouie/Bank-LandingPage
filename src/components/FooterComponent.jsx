export default function FooterComponent() {
  return (
    <footer className="bg-[#3E436A] flex px-12 pt-10 pb-10">
      <div className="basis-1/4 flex-col">
        ...
        <div className="flex gap-x-2 justify-start pt-10">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
            <path
              className="hover:fill-[#31d35c] hover:cursor-pointer"
              fill="#FFF"
      ...
      <div className="basis-1/4 text-white flex justify-around">
        <ul>
          <li className="py-[.1rem] hover:cursor-pointer hover:text-[#31d35c]">
            About Us
          </li>
          <li className="py-[.1rem] hover:cursor-pointer hover:text-[#31d35c]">
            Contact
      ...
      <div className="basis-1/4 justify-around">
        <button className="bg-[#31d35c] text-white py-2 px-8 rounded-3xl my-3 ml-14">
          Request Invite
        </button>
        <p className="text-start text-[#76798f]">
